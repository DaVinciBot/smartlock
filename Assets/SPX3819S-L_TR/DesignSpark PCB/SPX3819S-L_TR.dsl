SamacSys ECAD Model
1702959/1741291/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SPX3819S-L_TR" (originalName "SPX3819S-L_TR")
	...
	(compDef "SPX3819S-L_TR" (originalName "SPX3819S-L_TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "ADJ") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "GND_4") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "GND_3") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "GND_2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "GND_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SPX3819S-L_TR"))
		...
		(attr "Mouser Part Number" "701-SPX3819S-L/TR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/MaxLinear/SPX3819S-L-TR?qs=S%2FCBhQS5rCrzMX4peN58gQ%3D%3D")
		(attr "Manufacturer_Name" "MaxLinear, Inc.")
		(attr "Manufacturer_Part_Number" "SPX3819S-L/TR")
		(attr "Description" "LDO Voltage Regulators 500mA LOW NOISE LDO")
		(attr "Datasheet Link" "https://www.maxlinear.com/document?id=22106")
		(attr "Height" "1.75 mm")
	)
