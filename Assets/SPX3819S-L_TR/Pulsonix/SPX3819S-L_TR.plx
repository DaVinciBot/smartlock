...
(library Library_1
	...
	(compDef "SPX3819S-L_TR" (originalName "SPX3819S-L_TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "ADJ") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "GND_4") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "GND_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.maxlinear.com/document?id=22106")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "SPX3819S-L_TR.stp")
