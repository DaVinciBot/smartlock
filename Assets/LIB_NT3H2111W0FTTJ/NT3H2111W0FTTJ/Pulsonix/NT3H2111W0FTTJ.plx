...
//11363412/1724850/2.50/8/3/Undefined or Miscellaneous
...
(library Library_1
	...
	(symbolDef "NT3H2111W0FTTJ" (originalName "NT3H2111W0FTTJ")
	...
	(compDef "NT3H2111W0FTTJ" (originalName "NT3H2111W0FTTJ") (compHeader (numPins 8) (numParts 1) (refDesPrefix U)
		)
		(compPin "1" (pinName "LA") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "VSS") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "3" (pinName "SCL") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "4" (pinName "FD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "LB") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "VOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "6" (pinName "VCC") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "5" (pinName "SDA") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "NT3H2111W0FTTJ"))
		...
		(attr "Arrow Part Number" "NT3H2111W0FTTJ")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/nt3h2111w0fttj/nxp-semiconductors?utm_currency=USD&region=nac")
		(attr "Manufacturer_Name" "NXP")
		(attr "Manufacturer_Part_Number" "NT3H2111W0FTTJ")
		(attr "Description" "NXP - NT3H2111W0FTTJ - NTAG I- C <I>PLUS</I> 1K, NFC FORUM TYPE 2 TAG WITH I- C INTERFACE OPTIMIZED FOR ENTRY-LEVEL NFC APPLICATIONS, REEL 13" Q1 NDP,")
		(attr "<Hyperlink>" "https://www.arrow.com/en/products/nt3h2111w0fttj/nxp-semiconductors?utm_currency=USD&region=nac")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "NT3H2111W0FTTJ.stp")
