...
(library Library_1
	...
	(compDef "NT3H2111W0FTTJ" (originalName "NT3H2111W0FTTJ") (compHeader (numPins 8) (numParts 1) (refDesPrefix U)
		...
		(compPin "1" (pinName "LA") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "4" (pinName "FD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "LB") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.arrow.com/en/products/nt3h2111w0fttj/nxp-semiconductors?utm_currency=USD&region=nac")
		(attr "Height" "1.1 mm")
	)
