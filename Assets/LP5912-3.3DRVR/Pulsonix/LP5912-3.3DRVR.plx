...
(library Library_1
	...
	(symbolDef "LP5912-3.3DRVR" (originalName "LP5912-3.3DRVR")
	...
	(compDef "LP5912-3.3DRVR" (originalName "LP5912-3.3DRVR") (compHeader (numPins 7) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "PG") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LP5912-3.3DRVR"))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/lp5912")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "LP5912-3.3DRVR.stp")
